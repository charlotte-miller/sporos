...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "app" do |role|
    role.vm.provider "docker" do |dock|
      # dock.build_dir = "."
      # dock.image = "dockerfile/ruby"
      dock.image = "phusion/baseimage"
  ...
  #     d.build_dir = "./docker"
  #     # d.image = "dockerfile/ruby"
  #     # d.cmd       = ['ls', '/app']
  #     # d.remaining_running = false
  #   end
  # end
  #
  # # http://dockerfile.github.io/
  #
  # config.vm.define "db" do |role|
  #   role.vm.define "docker" do |d|
  #     d.image = "dockerfile/mariadb"
  #   end
  # end
  #
  # config.vm.define "search" do |role|
  #   role.vm.define "docker" do |d|
  #     d.image = "dockerfile/elasticsearch"
  #   end
  # end
  #
  # config.vm.define "redis" do |role|
  #   role.vm.define "docker" do |d|
  #     d.image = "dockerfile/redis"
  #   end
  # end
  #
  # config.vm.define "web" do |role|
  #   role.vm.define "docker" do |d|
