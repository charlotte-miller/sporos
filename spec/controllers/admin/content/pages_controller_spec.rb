...
RSpec.describe Admin::Content::PagesController, :type => :controller do
  ...
  before(:all) do
    @valid_attributes = attributes_for(:content_page)
    @valid_session    = {}
  end
  ...
  describe "GET index" do
    it "assigns all content_pages as @content_pages" do
      page = Content::Page.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:content_pages)).to eq([page])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested content_page as @content_page" do
      ...
      expect(assigns(:content_page)).to eq(page)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new content_page as @content_page" do
      ...
      expect(assigns(:content_page)).to be_a_new(Content::Page)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Content::Page" do
        expect {
          post :create, {:content_page => valid_attributes}, valid_session
        }.to change(Content::Page, :count).by(1)
      end

      it "assigns a newly created content_page as @content_page" do
        post :create, {:content_page => valid_attributes}, valid_session
        expect(assigns(:content_page)).to be_a(Content::Page)
        expect(assigns(:content_page)).to be_persisted
      end

      it "redirects to the created content_page" do
        post :create, {:content_page => valid_attributes}, valid_session
        expect(response).to redirect_to(admin_content_page_url(Content::Page.last))
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved content_page as @content_page" do
        post :create, {:content_page => invalid_attributes}, valid_session
        expect(assigns(:content_page)).to be_a_new(Content::Page)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested content_page" do
        page = Content::Page.create! valid_attributes
        put :update, {:id => page.to_param, :content_page => new_attributes}, valid_session
        page.reload
      ...
      it "assigns the requested content_page as @content_page" do
        page = Content::Page.create! valid_attributes
        put :update, {:id => page.to_param, :content_page => valid_attributes}, valid_session
        expect(assigns(:content_page)).to eq(page)
      end
    ...
    describe "with invalid params" do
      it "assigns the content_page as @content_page" do
        page = Content::Page.create! valid_attributes
        put :update, {:id => page.to_param, :content_page => invalid_attributes}, valid_session
        expect(assigns(:content_page)).to eq(page)
      end
