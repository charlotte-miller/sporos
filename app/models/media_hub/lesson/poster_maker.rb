...
class Lesson::PosterMaker < ActiveRecord::Base
  ...
  #                     :processors => [:ffmpeg],
  #                     :styles => {
  #                       sd_2:  { geometry: Lesson::AttachedSD_SIZE,  :format => 'png', :time => 2  },
  #                       sd_4:  { geometry: Lesson::AttachedSD_SIZE,  :format => 'png', :time => 4  },
  #                       sd_6:  { geometry: Lesson::AttachedSD_SIZE,  :format => 'png', :time => 6  },
  #                       sd_8:  { geometry: Lesson::AttachedSD_SIZE,  :format => 'png', :time => 8  },
  #                       sd_10: { geometry: Lesson::AttachedSD_SIZE,  :format => 'png', :time => 10 },
  #                       sd_12: { geometry: Lesson::AttachedSD_SIZE,  :format => 'png', :time => 12 },
  #                       sd_14: { geometry: Lesson::AttachedSD_SIZE,  :format => 'png', :time => 14 },
